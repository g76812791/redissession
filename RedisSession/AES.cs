...
namespace RedisSession
{
    ...
    {
        static string AESIV =ConfigurationManager .AppSettings["AesIV"];

        static string AESKey = ConfigurationManager.AppSettings["AesKey"]; 
        /// <summary>
        /// 加密
        /// </summary>
        ...
        {
            return EncryptByAES(strToEncrypt, AESKey);
        }
        ...
        {
            return DecryptByAES(strToDecrypt, AESKey);
        }
